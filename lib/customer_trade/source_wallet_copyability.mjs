...
export function buildSourceWalletCopyabilityMatrix(
  ...
  return freeze({
    ...
    size_stress: buildCopyabilitySizeStress(selectedRows, bySize, selected?.prospective_signal_count || 0),
    detection_market_context: detectionMarketContext,
    market_regimes: buildCopyabilityMarketRegimes(selectedRows, generated, SourceWalletCopyabilityLimits.reference_order_size_usdc),
    crowding: buildSourceWalletCopyCrowdingPublicSummary(crowdingObservations),
