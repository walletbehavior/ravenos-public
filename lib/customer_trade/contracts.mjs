...
export const CustomerTradeSchemaVersions = Object.freeze({
  ...
  hyperliquid_market_preview: "ravenos.hyperliquid_market_preview.v1",
  hyperliquid_order_plan: "ravenos.hyperliquid_order_plan.v1",
...
export const ProviderComponents = Object.freeze([
  ...
  "atlas_macro_context",
  "perp_market_context",
  "hyperliquid_market_preview",
  "hyperliquid_order_plan",
  "hyperliquid_account_snapshot",
  "hyperliquid_account_scenario",
  "hyperliquid_account_history",
]);
