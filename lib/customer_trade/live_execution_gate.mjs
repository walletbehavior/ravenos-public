...
export const CustomerLiveExecutionAuthorization = Object.freeze({
  ...
  // Solana remains quote/review-only until its exact Jupiter transaction,
  // signature, submission, and settlement reconciliation path is complete.
  solana_signed_transaction_submission: false,
  raven_signing: false,
...
export function resolveCustomerLiveExecutionGate(env = {}, principal = null, { nowSeconds = Math.floor(Date.now() / 1000) } = {}) {
  ...
  const sourceReady = hyperliquidSourceReady || solanaSourceReady;
