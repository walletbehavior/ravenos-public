...
export const DISCOVER_REVIVAL_SCAN_SCHEMA = "ravenos.discover_revival_scan.v1";
export const DISCOVER_CLASSIFIER_NAME = "raven_behavioral_radar";
export const DISCOVER_CLASSIFIER_VERSION = "2026-09-01.1";
...
function revivalScanEvidence(row, observedAt, freshnessState = "current") {
  ...
  return Object.freeze({
    ...
    source_scope: "exact_pool_current_rolling_windows",
    observed_at: iso(observedAt),
    freshness: freshnessState,
