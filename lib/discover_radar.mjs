  ...
  const base = {
    ...
    discovery: Object.freeze({
      ...
      decision_support: Object.freeze({
        ...
        what_strengthens: cleanText(row?.decision_support?.what_strengthens, 220) || "Participation and route depth should persist through the next market update.",
        ...
        next_checkpoint: cleanText(row?.decision_support?.next_checkpoint, 140) || (observationCount < 2 ? "Await the next market update." : `Re-evaluate after the next ${timeframe} market update.`),
      }),
