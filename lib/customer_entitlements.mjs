...
export const CustomerEntitlementContract = Object.freeze({
  ...
  defaults: Object.freeze({ resolution: false, authenticated_routes: false, projection_split: false, perps: false, participants: false, alerts: false, wallet_copy: false, wallet_copy_routes: false }),
