...
function basicWalletProfile(profile) {
  ...
  return Object.freeze({
    ...
    profit_quality: null,
    positions: { known_cost_open_positions: [], known_cost_open_position_count: null, unresolved_cost_basis_event_count: null },
    capital_observations: { current_balance_claimed: false },
    data_quality: {
