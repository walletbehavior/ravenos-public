...
export function participantIntelligence(row = {}, context = {}) {
  ...
  return {
    ...
    summary: "Participant Intelligence describes which behavior groups are contributing to pressure and structure. It does not expose private participant identifiers or replication instructions.",
    participants,
