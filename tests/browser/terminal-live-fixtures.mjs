  ...
  await page.route("**/api/trade/flags", (route) => route.fulfill({
    ...
    body: JSON.stringify({
      ...
      trade_adapter_states: {
        ...
        base: qualifiedSpotQuoteChains.includes("base") ? "wallet_execution" : "adapter_pending",
        bsc: qualifiedSpotQuoteChains.includes("bsc") ? "wallet_execution" : "adapter_pending",
        ethereum: qualifiedSpotQuoteChains.includes("ethereum") ? "wallet_execution" : "adapter_pending",
        robinhood: qualifiedSpotQuoteChains.includes("robinhood") ? "wallet_execution" : "adapter_pending",
      ...
      evm_fee_preview: {
        ...
        pro_fee_bps: 70,
        pro_discount_pct: 30,
        actual_fee_bps: qualifiedSpotQuoteChains.some((chain) => ["robinhood", "bsc", "base", "ethereum"].includes(chain)) ? 100 : 0,
        enabled: qualifiedSpotQuoteChains.some((chain) => ["robinhood", "bsc", "base", "ethereum"].includes(chain)),
        chains: {
          robinhood: {
            free_fee_bps: 100,
            pro_fee_bps: 70,
            pro_discount_pct: 30,
            actual_fee_bps: qualifiedSpotQuoteChains.includes("robinhood") ? 100 : 0,
            enabled: qualifiedSpotQuoteChains.includes("robinhood"),
          },
          bsc: {
            free_fee_bps: 100,
            pro_fee_bps: 70,
          ...
          base: {
            ...
            pro_fee_bps: 70,
            pro_discount_pct: 30,
            actual_fee_bps: qualifiedSpotQuoteChains.includes("base") ? 100 : 0,
            enabled: qualifiedSpotQuoteChains.includes("base"),
          },
          ethereum: {
            free_fee_bps: 100,
            pro_fee_bps: 70,
            pro_discount_pct: 30,
            actual_fee_bps: qualifiedSpotQuoteChains.includes("ethereum") ? 100 : 0,
            enabled: qualifiedSpotQuoteChains.includes("ethereum"),
          },
        },
      },
      flags: {
